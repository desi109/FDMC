...
public class CatAllServlet extends HttpServlet {
    ...
    private final static String ALL_CATS_HTML_FILE_PATH = "C:\\Users\\Dess\\IdeaProjects\\FDMC\\src\\main\\resources\\views\\cat-all.html";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getSession().getAttribute("cats") == null) {
            ...
            ((Map<String, Cat>) req.getSession().getAttribute("cats")).values().stream().forEach(cat -> {
